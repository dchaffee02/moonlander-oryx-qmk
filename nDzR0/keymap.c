...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_CALCULATOR,  CW_TOGG,        KC_DOWN,        KC_UP,          KC_TAB,         MT(MOD_LCTL, KC_APPLICATION),                                                                                                DUAL_FUNC_0,    KC_HOME,        KC_EQUAL,       KC_LBRC,        KC_RBRC,        KC_END,         
    KC_SPACE,       MT(MOD_LSFT, KC_ENTER),KC_RIGHT_ALT,                   KC_LEFT_ALT,    KC_CAPS,        OSM(MOD_LSFT)
  ),
  [1] = LAYOUT_moonlander(
    TO(0),          UC(0x0DA3),          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    ...
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          RGB_MODE_FORWARD,                                                                                                KC_NO,          KC_KP_0,        KC_KP_COMMA,    KC_KP_DOT,      KC_KP_EQUAL,    UC(0x0065),          
